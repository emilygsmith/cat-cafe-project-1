...
![Menus](assets/images/feature-menu.png)
...
![Meet the Cats](assets/images/feature-cats.png)
...
![Sign-Up Form](assets/images/feature-signup.png)
...
* HTML
    * No errors were returned when checking via the official [W3C validator](https://validator.w3.org/nu/):
    ...
    ![Signup Page Validator Test](assets/images/signup-html-validator.png)
...
![Lighthouse Testing Screenshot](assets/images/lighthouse-test.png)
